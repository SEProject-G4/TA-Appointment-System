...
const EditModuleDetails: React.FC = () => {
  ...
  const confirmSubmission = async () => {
    ...
    try {
      ...
      await axiosInstance.patch(`/lecturer/modules/${pendingModuleId}`, payload);
                    ...
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                            ...
                            <div className="text-center">
                              <div className="flex items-center justify-center gap-2">
                                ...
                                <p className="text-sm text-text-primary/70">hours per week</p>
                              </div>
                </div>
              </div>
                          ...
                          <div className="bg-white/50 rounded-lg p-2 border border-info/20 flex-1">
                            ...
                            <div className="text-center">
                              <div className="flex items-center justify-center gap-2">
                                ...
                                <p className="text-sm text-text-primary/70">teaching assistants</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full mx-4 shadow-2xl transform transition-all">
            ...
            >
                {updating[pendingModuleId || ''] ? 'Submitting...' : 'Confirm & Submit'}
            </button>
            </div>
          </div>
      </div>
