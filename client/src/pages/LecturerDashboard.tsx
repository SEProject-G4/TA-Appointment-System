...
//           {/* Tab Navigation */}
//           <div className="flex space-x-2 bg-bg-card rounded-lg p-2 mb-6 border border-border-default max-w-5xl mx-auto">
//             {tabs.map((tab) => (
//               <button
//                 key={tab.id}
//                 onClick={() => setActiveTab(tab.id as 'view' | 'edit' | 'requests')}
//                 className={`flex-1 py-4 px-6 rounded-md font-medium transition-colors duration-200 text-sm ${
//                   activeTab === tab.id
