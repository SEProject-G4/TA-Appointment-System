  ...
  describe('User Management Routes (/api/user-management)', () => {
    ...
    describe('POST /api/user-management/groups', () => {
      ...
      it('should validate required fields', async () => {
        ...
        expect(res.body).toEqual({ error: 'Group type is required' });
      });
      ...
      it('should handle duplicate group names', async () => {
        ...
        UserGroup.create.mockRejectedValue(new Error('Duplicate key error'));
    ...
    describe('GET /api/user-management/groups/:groupId/users', () => {
      it('should return users in a specific group', async () => {
        ...
        const expectedPayload = [
          { _id: 'user1', name: 'John Doe', email: 'john@cse.mrt.ac.lk', indexNumber: 'E/20/001', profilePicUrl: null, dateAdded: expect.any(Date) },
          { _id: 'user2', name: 'Jane Smith', email: 'jane@cse.mrt.ac.lk', indexNumber: 'E/20/002', profilePicUrl: null, dateAdded: expect.any(Date) }
        ];
